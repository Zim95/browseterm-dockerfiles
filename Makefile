...
build_all: build_ubuntu build_snapshot_sidecar build_status_sidecar
...
.PHONY: build_ubuntu build_snapshot_sidecar build_status_sidecar build_all test_deployment_setup test_deployment_teardown
